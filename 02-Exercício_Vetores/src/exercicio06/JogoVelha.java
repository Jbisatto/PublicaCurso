	...
	public static void main(String[] args) {
		...
		while (parar) {
			...
			while (numeroRepetido) {
				posicao = Integer.parseInt(JOptionPane.showInputDialog("Jogador X Informe a posição"));
				...
				case 1:
					if (jogo[0][0] == '1') {
						...
						JOptionPane.showMessageDialog(null, "Posição já marcada!!!");
					}
					break;
				case 2:
					if (jogo[0][1] == '2') {
...
//Diagonais				
			...
			while (numeroRepetido) {
				posicao = Integer.parseInt(JOptionPane.showInputDialog("Jogador O Informe a posição"));
